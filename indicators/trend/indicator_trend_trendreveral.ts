#Descriptions
# Use moving averages, ZigZag pattern,
# and Fibonacci to generate reversal signals on your chart.
# https://usethinkscript.com/threads/trend-reversal-indicator-with-signals-for-thinkorswim.183/

# One thing to note is that this indicator will repaint.
# The Buy and Sell signal will disappear if the candlestick closed above or below the stop loss line. You can use that as a trigger point to cut losses early if that happens.

# Green = Buy Signal Bars
# Purple = Neutral
# Red = Sell Signal Bars
